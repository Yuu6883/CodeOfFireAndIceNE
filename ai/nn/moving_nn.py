...
import numpy as np
import random
from ai.nn_constants import MOVING_INPUT, MOVING_HLAYER1, MOVING_HLAYER2, \
...
class MovingAgent:
    ...
    def randomize(self):
        ...
        self.h_out = tf.Variable(tf.random_normal([MOVING_HLAYER2, 1]))
        self.build_layers()
    ...
    def set_weights(self, weights: list):
        ...
        h_out_weights = weights[offset: offset + MOVING_HLAYER2]
        offset += MOVING_HLAYER2
        ...
        self.h_out.assign(np.reshape(h_out_weights, (MOVING_HLAYER2, 1))),
